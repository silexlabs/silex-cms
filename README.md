...
> **⚠️ DEPRECATED**: This plugin has been integrated into the main [silex-lib](https://github.com/silexlabs/silex-lib/) package. Please migrate to using silex-lib directly instead of this standalone plugin.
